...
_CONFIG_VARSAYILAN = {
    ...
    "ACIK_SEANS_MAX_SAAT": 24.0,
    "MIN_CIKIS_NET_AGIRLIK": 0.0,
    "PLAKA_MANUEL_DUZELTMELER": {},
    "BILINEN_PLAKA_OTODUZELT": False,
    "BILINEN_PLAKA_KUME_BONUSU": False,
