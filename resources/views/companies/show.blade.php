    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('companies.report', $company) }}?{{ http_build_query($filters) }}" target="_blank"
                   class="inline-flex items-center justify-center rounded-full border border-sky-400/30 bg-sky-400/10 px-4 py-2 text-sm font-semibold text-sky-200 transition hover:bg-sky-400/15">
                    Yazdir / PDF
                </a>
